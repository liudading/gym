...
register(
   	id='EVCharging-v0',
   	entry_point='gym.envs.safety:EVCharging',
)

register(
   	id='EVCharging-v1',
   	entry_point='gym.envs.safety:EVChargingDiscrete',
)

register(
   	id='EVCharging-v2',
   	entry_point='gym.envs.safety:EVChargingPenalty',
)

register(
   	id='SmartHome-v0',
   	entry_point='gym.envs.safety:SmartHome',
)

register(
   	id='SmartHome-v1',
   	entry_point='gym.envs.safety:SmartHome_v1',
)
